...
# Focal loss in the below link.
# https://github.com/clcarwin/focal_loss_pytorch


def get_LR_label(model, x_org, y_org, yl_org, device, gamma, nb_classes=4):
    # model: pre-trained SER model
    # input feature: x_org
    # target label: y_org
    # target label or smoothed label: yl_org 
    ...
    # Label smoothing on misclassified data
    yl_org[pred!=y_org]=np.eye(4)[y_org[pred!=y_org]]*(1-gamma) + gamma/nb_classes 
    
    return yl_org # new label